...
module Surfaces {
    ...
    export var checkedborad: Surface = {
...
function defaultScene(): Scene {
    return {
        things: [
            new Plane(new Vector(0.0, 1.0, 0.0), 0.0, Surfaces.checkedborad),
        ...
        camera: new Camera(new Vector(3.5, 2.5, 4.5), new Vector(-1.0, 0.5, 0.0))
    };
}
